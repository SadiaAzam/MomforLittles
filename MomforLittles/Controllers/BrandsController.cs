...
namespace MomforLittles.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public JsonResult CheckUsernameAvailability(string userdata)
        {
            ...
            var SeachData = db.Brands.Where(x => x.BRAND_EMAIL == userdata).SingleOrDefault();
            if (SeachData != null)
            {
                return Json(1);
            }
        ...
        [HttpPost]
        public ActionResult ForgotPassword(Brand user)
        {
            Brand tbluser = db.Brands.Where(a => a.BRAND_EMAIL == user.BRAND_EMAIL).FirstOrDefault();
            if (tbluser != null)
            {
                ...
                MailMessage mail = new MailMessage();
                mail.From = new MailAddress("momforlittles306@gmail.com");
                mail.To.Add(tbluser.BRAND_EMAIL);
                mail.Subject = "Forgot PAssword";
                mail.Body = "<b>Mom4Littles!</b><br /> Your Password is given below:<br />" + tbluser.BRAND_PASSWORD;
                mail.IsBodyHtml = true;
                ...
                return RedirectToAction("Login", "Brands");

            }
            else
            {
                TempData["abc"] = "Not a Valid Account.";
                return RedirectToAction("ForgotPassword", "Brands");
