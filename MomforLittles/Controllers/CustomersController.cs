...
namespace MomforLittles.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public JsonResult CheckUsernameAvailability(string userdata)
        {
            ...
            var SeachData = db.Customers.Where(x => x.CUSTOMER_EMAIL == userdata).SingleOrDefault();
            if (SeachData != null)
            {
                return Json(1);
            }
        ...
        [HttpPost]
        public ActionResult ForgotPassword(Customer user)
        {
            Customer tbluser = db.Customers.Where(a => a.CUSTOMER_EMAIL == user.CUSTOMER_EMAIL).FirstOrDefault();
            if (tbluser != null)
            {
                ...
                MailMessage mail = new MailMessage();
                mail.From = new MailAddress("momforlittles306@gmail.com");
                mail.To.Add(tbluser.CUSTOMER_EMAIL);
                mail.Subject = "Forgot PAssword";
                mail.Body = "<b>Mom4Littles!</b><br /> Your Password is given below:<br />" + tbluser.CUSTOMER_PASSWORD;
                mail.IsBodyHtml = true;
